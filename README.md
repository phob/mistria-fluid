# ARPG Movement 2.4.0 (for Fields of Mistria 1.0)

ARPG Movement 2.4.0 is ready for Fields of Mistria 1.0.3 and requires MOMI
...
- `dist/ARPGMovement-2.4.0.zip` — Nexus-ready package.
