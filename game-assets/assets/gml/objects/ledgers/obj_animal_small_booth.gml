object_create(
    ...
    object_reserve("par_ledger"),
    {
        ...
        create: function() {
            ...
            self.small_icon = spr_ui_bark_icon_chicken_small;
            self.big_icon = spr_ui_bark_icon_chicken;
            ...
            self.register_interaction(
                ...
                function() {
                    animal_festival_selection_popup(AnimalSize.Small);
                },
                function() {
