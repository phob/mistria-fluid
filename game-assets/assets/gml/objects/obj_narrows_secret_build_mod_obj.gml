object_create(
    "obj_narrows_secret_build_mod_obj",
    undefined,
    {
        sprite_index: spr_narrows_cave_entrance_spring_top,
        create: function() {
            ...
            self.depth = room_data_layer_depth(rm_narrows, "Level_0_WallsNatural");

            self.cave_entrance = try_get_seasonal_sprite_alt(spr_narrows_cave_entrance_spring) ?? spr_narrows_cave_entrance_spring;
            ...
            if !world_mod_enabled(WorldMod.NarrowsSecret) {
                ...
                self.trigger = instance_create_layer(
                    ...
                    obj_fire_trigger,
                    {
                        ...
                        cutscene: "narrows_secret",
                        can_burn: function() {
                            return instance_exists(obj_ari)
                                && obj_ari.fsm.current_state_id() == PlayerState.Default
                                && instance_exists(obj_narrows_secret_build_mod_obj)
                                && obj_narrows_secret_build_mod_obj.y <= obj_ari.y;
                        },
                    }
                );
        ...
        step: function() {
            var was_making_noise = !world_mod_enabled(WorldMod.NarrowsSecret)
